...
//    let Mates = NetworkReachabilityManager()
    ...
    private  func FotoFlockGetr()->(Bool,Bool,Bool){//2025 1761015295
        return (Date().timeIntervalSince1970 > 1234 ,true,true)
    ...
    private func likeingPoseMan()  {
        ...
        let SmartStrikePOOS: [String: Any] = [
            ...
            "deviceType": CanvasClick,
            "version": FramedFinesse,

            "language":UITextInputMode.activeInputModes.compactMap { $0.primaryLanguage }
        ]
        ShutterHive.contentMode = .scaleAspectFill
        ShutterHive.isHidden = true
