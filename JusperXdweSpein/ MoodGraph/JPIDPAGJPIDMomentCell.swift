...
class JPIDPAGJPIDMomentCell: UICollectionViewCell {
    ...
    lazy var reorinttrAloi: UIButton = {
        ...
        uitr.setImage(UIImage.init(named: "JPIDPAGicon_agreenlaert"), for: .normal)
        
        return uitr
    }()
    
    let faveriteView = UIImageView(image: UIImage.init(named: "JPIDPAGlaikeing"),highlightedImage: UIImage.init(named: "JPIDPAGlaikeing_herr"))
...
class JPIDBlueUserCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let iamge = UIImageView.init(image: UIImage.init(named: "JPIDPAmensbane"))
        iamge.frame = CGRect(x: 0, y: 0, width: 56, height: 56)
