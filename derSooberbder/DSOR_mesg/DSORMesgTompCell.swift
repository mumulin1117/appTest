...
class DSORMesgTompCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        robercentHEaderDSOR.layer.cornerRadius = 30
        ...
        robertnameDSOR.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(berVfhuDSOR.snp.bottom).offset(12)
