...
class MMopPigmentLabController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        rhythm.setTitle(ArtisticPoetry.MMOPSDextractVibrantPigments(MMOPSDcolorFormula:"Fzobrj qygozu" ), for: .normal)
        rhythm1.setTitle(ArtisticPoetry.MMOPSDextractVibrantPigments(MMOPSDcolorFormula:"Neekw" ), for: .normal)
        rhythm2.setTitle(ArtisticPoetry.MMOPSDextractVibrantPigments(MMOPSDcolorFormula:"Fmohlkljomwaiwndg" ), for: .normal)
