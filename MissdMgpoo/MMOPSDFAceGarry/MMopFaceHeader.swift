...
class MMopFaceHeader: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBOutlet weak var faceshowMMopS: UILabel!
    
    @IBOutlet weak var faceShowView: UICollectionView!
    
    @IBOutlet weak var skinMMPSOD: UILabel!
    ...
    func initnialHearView()  {
        ...
        faceshowMMopS.text =  ArtisticPoetry.MMOPSDextractVibrantPigments(MMOPSDcolorFormula:"FvahcfeiSahgosw" )
        skinMMPSOD.text =  ArtisticPoetry.MMOPSDextractVibrantPigments(MMOPSDcolorFormula:"AorhtgSikyiin" )
