...
extension MMopFaceGalleryViewController{
    ...
    func expressiveUsersTextures()  {
        ...
        var enputCOunt = 3
        color = UIColor.red
        MMOPSDRebellionController.canvasTransmissionChannel(boldtextures:color,stylepoetry:enputCOunt,artisticCollective: "/cmpwmusfyubdxz/xapoqkuqq", pigmentComposition: ["faceart":"54684883"]) { anydata in
