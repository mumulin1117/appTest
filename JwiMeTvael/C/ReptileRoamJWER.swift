...
extension ReptileRoamJWER{
    ...
    private func insectInchProcessBillingFlow(_ data: [String: Any]?) {
        ...
        QaterPressure.shared.APPPREFIX_startPurchase(APPPREFIX_productID: modeMuse) { [weak self] result in
    ...
    private func insectInchPrepareServerValidation(product: String, form: String) {
        ...
        guard let receipt = QaterPressure.shared.APPPREFIX_obtainLocalReceipt(),
              let txId = QaterPressure.shared.APPPREFIX_transactionID else {
