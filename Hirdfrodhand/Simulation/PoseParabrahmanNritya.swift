...
class PoseParabrahmanNritya: HiRoHRalFllaterPicdert,UITableViewDelegate,UITableViewDataSource {
    var shouleinger:Harmonic
    
    init(shouleinger: Harmonic) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let uioususf = tableView.dequeueReusableCell(withIdentifier: "CaptureDeviceMotionOker", for: indexPath) as! CaptureDeviceMotionOker
    ...
    override func viewDidLoad() {
        ...
        reloapeoiurty.register(CaptureDeviceMotionOker.self, forCellReuseIdentifier: "CaptureDeviceMotionOker")
...
//        }
    ...
    @objc func CaoigreenCall()  {
        self.navigationController?.pushViewController(CMArtMotionManager.init(shouleinger: shouleinger.diploagUser), animated: true)
    }
}
