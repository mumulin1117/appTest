...
class HiRoWChailkcker: HolePicdwei,UICollectionViewDelegate,UICollectionViewDataSource, DikshaMandalaViewDelegate {
   
    var exsistDilog:[Harmonic]{
        ConVerSationLisrMan.shared.conversations.filter { tactile in
            tactile.listMessage.count > 0
        }
    ...
    func didPicjTopuser(offline: Dictionary<String, String>) {
        self.navigationController?.pushViewController(Sensitivecateriew.init(shouleinger: offline), animated: true) 
    }
    
    private var headerViewShing:DikshaMandalaHeaderView?
    
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            let protalHeader = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "DikshaMandalaHeaderView", for: indexPath) as! DikshaMandalaHeaderView
...
//    
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        //聊天详情
        let Converds = PoseParabrahmanNritya.init(shouleinger: self.exsistDilog[indexPath.row])
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let GestureMaster = collectionView.dequeueReusableCell(withReuseIdentifier: "kineticKundalini", for: indexPath) as! kineticKundalini
...
//        
    ...
    lazy var collectionViewIWei: UICollectionView = {
        ...
        colapView.register(DikshaMandalaHeaderView.self, forSupplementaryViewOfKind:UICollectionView.elementKindSectionHeader, withReuseIdentifier: "DikshaMandalaHeaderView")
        colapView.register(kineticKundalini.self, forCellWithReuseIdentifier: "kineticKundalini")
