...
class AddPickDanceController: UIViewController ,UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    private func adINweranitiner()  {
        ...
        cinTitledsf.text = "Dqannlcqeh lPzK".poseRealStr()
        ...
        cindsf.text = "Uspjloouawdm vyboyujrh hdfaqntcfee yvoildweeof jabnqda wcfhqaclllhennrgbev ttdhcea hcuheaimopuiyosni!j fTkhvej mohnsek ewlietihb xhsifgnhfesrd epkokpzuelfaprpiutjyl cwwioncsd.x oCmosmmeq jannodx asehbojwb yocfufp yyxopuorl odqaenicgidnbgv csmkiihlblxs".poseRealStr()
        ...
        Loaojgi.setTitle( "Uqpclcoyaxds dVviddoewo".poseRealStr(), for: .normal)
   ...
   @objc func fodeleteoutrINgtag()  {
       ...
       if isAddPictureL == false {
           self.addlayert(textCon: "Polyetapsged vaedddt jDfannycsetPjKk ivzildieco".poseRealStr(), controller: self,textColor: 2)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        UploaDancemapping.fetchThuaimPicture_hird(Jiu: true, lainderURL: lOnai) { thumbnail in
