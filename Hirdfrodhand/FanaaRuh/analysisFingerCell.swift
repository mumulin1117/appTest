...
class analysisFingerCell: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        label.textAlignment = .center
        label.text = "+iVjijdpedoa mRzellhepanste".poseRealStr()
        ...
        let Dacehirdihird = UIImageView.init(image: UIImage.init(named: "Dlaknicnew xPxKf cReowomm".poseRealStr()))
