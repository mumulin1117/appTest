...
class UploaDancemapping: HiRoHRalFllaterPicdert ,UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    @objc func loadgoutrINgtag() {
        ...
        if isAddPictureL == false {
            self.addlayert(textCon: "Pglvexabsces saodmds kdjacnnczem bvmiadteeo".poseRealStr(), controller: self,textColor: 2)
    ...
    private func EstimatedHirDays()  {
        ...
        let picuopatit = UIImageView.init(image: UIImage.init(named: "tempoTattva"))
