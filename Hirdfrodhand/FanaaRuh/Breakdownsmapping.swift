...
import MJRefresh
import AVFoundation
class Breakdownsmapping: HolePicdwei ,UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            let protalHeader = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "JnanaVedanta", for: indexPath) as! analysisFingerCell
            
            protalHeader.cameraPayHird.addTarget(self, action: #selector(uplorreChallenge), for: .touchUpInside)
    ...
    @objc func uplorreChallenge()  {
        
        self.navigationController?.pushViewController(UploaDancemapping.init(), animated: true)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(WeeklyThemedtnteller.init(igjiii: Cesf), animated: true)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let GestureMaster = collectionView.dequeueReusableCell(withReuseIdentifier: "kineticSamhita", for: indexPath) as! CompetitiveCell
        ...
        if let videlinkg = igjiii["hiroCamera_videws"]?.components(separatedBy: "@@@").first{
            GestureMaster.posphereneHo.image = StaccatoSamarasaYoga.chacheImage[videlinkg]
        }
    ...
    lazy var collectionViewIWei: UICollectionView = {
        ...
        colapView.register(analysisFingerCell.self, forSupplementaryViewOfKind:UICollectionView.elementKindSectionHeader, withReuseIdentifier: "JnanaVedanta")
        
        colapView.register(CompetitiveCell.self, forCellWithReuseIdentifier: "kineticSamhita")
