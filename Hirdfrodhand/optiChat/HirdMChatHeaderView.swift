...
import UIKit
protocol HirdMChatHeaderViewDelegate {
...
class HirdMChatHeaderView: UICollectionReusableView,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let heaf = collectionView.dequeueReusableCell(withReuseIdentifier: "HirdChatToplid", for: indexPath) as! HirdChatToplid
    ...
    lazy var collectionViewIWei: UICollectionView = {
        ...
        colapView.register(HirdChatToplid.self, forCellWithReuseIdentifier: "HirdChatToplid")
...
class HirdChatToplid: UICollectionViewCell {
    //头像
