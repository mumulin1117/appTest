...
/// 首页
class RoHandHomelTracker: HolePicdwei ,UICollectionViewDelegate,UICollectionViewDataSource, HikmatGuruifatDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            let protalHeader = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "hoayiHeader", for: indexPath) as! PyousableViewColView
    ...
    @objc func startRecordcealTime()  {
        self.navigationController?.pushViewController(GarbhaGrihaDarshana.init(), animated: true)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let zdvc = HikmatGuruifat.init(igjiii: Zhuwei, ismecenet: false)
        zdvc.delegate = self
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let GestureMaster = collectionView.dequeueReusableCell(withReuseIdentifier: "EMotionSquareCell", for: indexPath) as! EMotionSquareCell
    ...
    lazy var collectionViewIWei: UICollectionView = {
        ...
        colapView.register(PyousableViewColView.self, forSupplementaryViewOfKind:UICollectionView.elementKindSectionHeader, withReuseIdentifier: "hoayiHeader")
        colapView.register(EMotionSquareCell.self, forCellWithReuseIdentifier: "EMotionSquareCell")
        ...
        let deleteButton = DestructiveButton(title: "Bzlhobclk".poseRealStr()) {
            let statuslbl = self.addlayert(textCon: "Bmljoncwktilnrgi.i.o.".poseRealStr(),controller: self,timedelay: nil)
             ...
             DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1.5, execute: DispatchWorkItem(block: {
                 ...
                 ConVerSationLisrMan.shared.conversations = ConVerSationLisrMan.shared.conversations.filter({ harmonic in
                     harmonic.diploagUser["hiroUID"] != ifDer
                 })
                 if moreType == 4 {
