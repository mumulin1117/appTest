...
import UIKit
//导航栏
class Focusesintersection: UINavigationController {

    override func viewDidLoad() {
        super.viewDidLoad()

        let enhance = UINavigationBarAppearance()
                
        enhance.configureWithTransparentBackground()
        enhance.shadowColor = .clear
        
        navigationBar.standardAppearance = enhance
        navigationBar.scrollEdgeAppearance = enhance
        navigationBar.compactAppearance = enhance
    }
