//
//  BorderlessBeatsControler.swift
//  Duelliobuaf
//
...
class BorderlessBeatsControler:  LaterPageContirl,UITableViewDelegate,UITableViewDataSource {
    var relaoty:Int
    init(relaoty: Int) {
    ...
    private lazy var nameeLabel: UILabel = {
        ...
        if relaoty == 0 {
            laj.text = LaterPageContirl.generateDUEDUEBne(ado: 355, meifutuer: "Fhaanns")
        }else{
            laj.text = LaterPageContirl.generateDUEDUEBne(ado: 355, meifutuer: "Fzobltlrosw")
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(CChieCenterCotnoer.init(dfoloower: aslopj), animated: true)
    }
...
class DUEDRelaironsgcell: UITableViewCell {
    ...
    private lazy var sayneLabel: UILabel = {
        let laj = UILabel.init()
         laj.text = LaterPageContirl.generateDUEDUEBne(ado: 355, meifutuer: "Cshheqczk")
