...
import Loaf
//聊天
class DUEITChatipoContoll: DUELaterPageContirl, UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate {
    ...
    @objc func Tovalkjjifvideo()  {
        
        self.navigationController?.pushViewController(DUEITVidejshipoContoll.init(appdelegateFei: appdelegateFei), animated: true)
    }
