...
class IPGiftpeilCotnoller: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @objc func sureposdtpresent() {
        ...
        var balkfi =  Int(use?["SerenitySpin"] ?? "0") ?? 0
