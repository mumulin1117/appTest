//
//  SDIRTMELandingZoneController.swift
//  SkijutDefind
//
...
class SDIRTMELandingZoneController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let backcountry =  DIRTMEResortBoundController.init(secretSpot: .stormReport,localsOnly:"\(castUseridsh)")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let LandingZoneCell = collectionView.dequeueReusableCell(withReuseIdentifier: "SDIRTMELandingZoneCell", for: indexPath) as! SDIRTMELandingZoneCell
        
        LandingZoneCell.chalet.SDIRTMEimplementation(SDIRTMEskillom: cepsu["poma"] as? String)
        
        if let aclist = cepsu["heliDrop"] as? Array<Dictionary<String,Any>>,let fui = aclist.first?["snowmaking"] as? String{
            
            LandingZoneCell.lodge.SDIRTMEimplementation(SDIRTMEskillom:fui )
    ...
    func longitudinalFlex()  {
        ...
        deepSlab.register(UINib.init(nibName: "SDIRTMELandingZoneCell", bundle: nil), forCellWithReuseIdentifier: "SDIRTMELandingZoneCell")
    ...
    func chatterReduction()  {
        ...
        SDIRTMEBackcountryAPISender.SDIRTMEsendMountainRequest(        SDIRTMEtrailPath: "/remshopwlz/hqzlbpwcbro",         SDIRTMEpayload: ["jib":"95578703"]) {zipperLine in
            ...
            guard let detail = response[SDIRTMERailSlideCell.untangleMountainR(isMultiple: 2, TrailMarkers: "dfagtja")] as? Array<[String: Any]> else {
                return
            }
