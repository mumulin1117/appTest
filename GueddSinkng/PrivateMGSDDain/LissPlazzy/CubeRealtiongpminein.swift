...
class CubeRealtiongpminein: UIViewController {
   
    
    var ModelgGSDD:Array<UserformanceShowcase>?{
        didSet{
    ...
    @objc func ginoUseringop(hyio:UIButton)  {
        ...
        self.navigationController?.pushViewController(AcoustthsdergtaoDComin.init(plazDeinGSDD: mingui), animated: true)
