...
class GSDDEfitInfoComin: UIView {
    ...
    override init(frame: CGRect) {
        ...
        entertYOuNAmeGSDD.text = GSDDDALoaing.chanGSDD.signinyhuGSDD?.gsddNjmet
        entertYOuBriefGSDD.text = GSDDDALoaing.chanGSDD.signinyhuGSDD?.gsddVBrief
