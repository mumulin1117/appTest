...
class EventPostControoer:  UIViewController ,UITextViewDelegate{
    ...
    @IBAction func themcapeHub(_ sender: UIButton) {
        ...
        guard them.count > 0
            ...
            loPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("cGxlYXNlIGVudGVyIHlvdXIgdGhlbSFjb20udHJtbGluLnRydWVscg=="))
        ...
        guard enentlocation.count > 0
            ...
            loPulseIndicatar.showInfo(withStatus:UIImageView.ambienceVaultDeu("cGxlYXNlIGVudGVyIHlvdXIgRXZlbnQgTG9jYXRpb24hY29tLnRybWxpbi50cnVlbHI=") )
        ...
        guard enentstart.count > 0
            ...
            loPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("cGxlYXNlIGVudGVyIHlvdXIgRXZlbnQgc3RhcnQgdGltZSFjb20udHJtbGluLnRydWVscg=="))
        ...
        guard endtime.count > 0
            ...
            loPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("cGxlYXNlIGVudGVyIHlvdXIgRXZlbnQgZW5kIHRpbWUhY29tLnRybWxpbi50cnVlbHI="))
        ...
        guard selectedMedia != nil else {
            loPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("UGxlYXNlIGFkZCBhbiBpbWFnZSAgZm9yIGV2ZW50LmNvbS50cm1saW4udHJ1ZWxy"))
                    return
    ...
    func villageSquare()  {
        ChronoEngine.executeAfterTemporalShift(2) {
            ...
            loPulseIndicatar.showInfo(withStatus: UIImageView.ambienceVaultDeu("UmVsZWFzZSBFdmVudCBzdWNjZXNzZnVsLHlvdXIgcG9zdCB3aWxsIGJlIGRpc3BsYXllZCBhZnRlciBhcHByb3ZhbGNvbS50cm1saW4udHJ1ZWxy"))
