...
class CreatorStudioPopView: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBOutlet weak var CRETEMCMOApolor: UILabel!
    
    
    
    var oklopp:CreatorStudioPopViewDelegate?
    
    var SleepAids :Array<CRETEMCMOAMindfulSerenity> = Array<CRETEMCMOAMindfulSerenity>()
    
    var BrushingAids :Array<CRETEMCMOAMindfulSerenity > = Array<CRETEMCMOAMindfulSerenity >()
   ...
   @objc func suresportu()  {
    ...
    func upafire()  {
        ...
        CRETEMCMOApolor.text = "🔥" + CRETEMCMOAStreamingController.CRETEMCMOAreconstructBaseLayer(CRETEMCMOAinterlacedScan: "Pxolpdudlmayro tAncytsijvwiktzinens")
